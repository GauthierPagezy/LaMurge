...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 27 fév. 2024 à 17:32
...
INSERT INTO `boisson` (`id`, `prix`, `nom`) VALUES
(1, 5, ''),
(2, 7.5, '');
...
INSERT INTO `concerne` (`id`, `prix`, `id_boisson`, `id_happyhour`) VALUES
(1, 4, 1, 2),
(2, 3, 2, 1);
...
INSERT INTO `detenir` (`id`, `id_bar`, `id_happyhour`) VALUES
(1, 2, 2),
(2, 1, 1);
...
INSERT INTO `evenement` (`id`, `date_heure`, `description`, `id_bar`) VALUES
(1, '0000-00-00 00:00:00', 'Soirée Jazz', 1),
(2, '0000-00-00 00:00:00', 'Concert Rock', 2);
...
--
-- Déchargement des données de la table `happyhour`
--

INSERT INTO `happyhour` (`id`, `debut`, `fin`) VALUES
(1, '17:00:00', '19:00:00'),
(2, '18:00:00', '20:00:00');
...
--
ALTER TABLE `detenir`
  ADD CONSTRAINT `detenir_ibfk_1` FOREIGN KEY (`id_bar`) REFERENCES `bar` (`id`),
